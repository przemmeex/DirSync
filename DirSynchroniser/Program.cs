    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                else if (!Directory.Exists(args[0]) || !Directory.Exists(args[1]) || !Directory.Exists(args[3])) parameterError = "entered path(s) is invalid";
                else if (!int.TryParse(args[2], out int intervalSeconds)) parameterError = "enter an integer for interval";
